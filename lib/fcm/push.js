...
import config from '../modules/services/config.json'
...
const org = typeof args.org !== 'undefined' ? args.org : 'elysium'

if (config[org].services[args.server]) {
  sendMessage({ ...config[org].services[args.server], status, unstable, org })
} else {
